...
try{
  ...
  if(payload.status!=='ok'||payload.service!=='planora')throw new Error(`unexpected health payload: ${JSON.stringify(payload)}`);
  ...
  console.log('✓ Planora production server smoke test passed');
}finally{
